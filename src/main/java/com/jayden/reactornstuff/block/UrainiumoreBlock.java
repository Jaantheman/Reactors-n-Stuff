...
public class UrainiumoreBlock extends ReactorNStuffModElements.ModElement {
	@ObjectHolder("reactor_n_stuff:urainiumore")
	public static final Block block = null;
	public UrainiumoreBlock(ReactorNStuffModElements instance) {
		super(instance, 3);
	}
	...
	public static class CustomBlock extends Block {
		...
		public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
			...
			return Collections.singletonList(new ItemStack(UrainiumItem.block, (int) (10)));
		}
	}
}
